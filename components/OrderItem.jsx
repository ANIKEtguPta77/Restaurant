  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col md:flex-row justify-around w-full p-2'>
        <div className='w-full md-w-7/12 flex flex-row'>
       
          <div className='w-1/2 md:w-11/12 flex flex-col justify-center items-center rounded-3xl border-2 border-solid border-black p-5 bg-black text-white'>
          ...
          <div className='w-1/2 md:w-11/12 flex flex-col justify-center items-center ml-2 sm:ml-6 md:ml-10 border-2 rounded-3xl border-black font-fred'>
              <p className='text-lg md:text-3xl font-extrabold h-1/6 mt-4'>Comments</p>
              <p className='h-5/6 mt-3 text-lg'>{order.comment}</p>
            
          </div>
        </div>
        <div className='w-full md:w-5/12 flex xs:flex-row md:flex-col lg:flex-row justify-between font-kal mt-7 m-3'>
          <motion.button 
